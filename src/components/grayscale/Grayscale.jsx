...
const Grayscale = () => {
  ...
  let grayscaler = async ()=>{
    ...
    await ffmpeg.exec(["-i",video.name,"-vf","hue=s=0","-acodec","copy",`output.${fileType}`]);
  ...
  return (
    ...
    { videoSrc && <button onClick={grayscaler} className='bg-green-300 w-full p-3 my-2 shadow-md cursor-pointer active:shadow-none '>Convert</button>}
